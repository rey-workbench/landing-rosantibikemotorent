						...
						<div class="bg-[#f5f5f7] border border-black/5 rounded-3xl overflow-hidden mb-6">
							...
							<div class="p-5 space-y-2.5 text-xs sm:text-sm">
								<div class="flex justify-between items-center">
									<span class="text-[#525257]">{$LL.booking_name_field()}</span>
									...
									<div class="border-t border-black/5 pt-2.5 mt-2.5">
										{#if formData.jasHujan > 0}
											<div class="flex justify-between items-center mt-1">
												<span class="text-[#525257]">{$LL.booking_raincoat_field()}</span>
										...
										{#if formData.helm > 0}
											<div class="flex justify-between items-center mt-1">
												<span class="text-[#525257]">{$LL.booking_helmet_field()}</span>
												<span class="text-apple-blue font-medium"
							...
							<div class="space-y-4">
								...
								<div class="bg-[#f5f5f7] border border-black/5 rounded-3xl p-6">
									<div class="flex justify-between items-center">
										<div>
											<p
												class="text-[#525257] text-xs font-semibold tracking-wider uppercase mb-0.5"
											>
