				...
				<div class="flex flex-wrap items-center gap-2 mb-5">
					...
					{#if post.tags}
						{#each post.tags as tag}
							<span class="px-2.5 py-0.5 text-[#6b6b70] text-[11px] font-medium rounded-full">
								#{tag.nama}
							</span>
						{/each}
					{/if}
				...
				>
					<div class="text-center md:text-left space-y-1.5">
						...
						<p class="text-sm text-[#6b6b70] max-w-md">
							Pesan unit motor atau sepeda elektrik impian Anda sekarang dengan proses online cepat
							dan unit prima.
						</p>
					</div>
					<div class="shrink-0">
