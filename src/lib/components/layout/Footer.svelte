	...
	<div class="max-w-5xl mx-auto px-4">
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-8 border-b border-black/10">
			<div class="space-y-3">
				...
				<a href="https://share.google/txOxHDzSGQxVfc1ql" target="_blank" rel="noopener noreferrer" class="mt-4 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-black/10 hover:border-black/20 transition-colors">
